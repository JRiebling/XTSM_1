...
class CommandLibrary():
    ...
    def compile_active_xtsm(self, params):
        ...
        if parent_dc == '':
            ...
            active_xtsm=pdc.get('_active_xtsm')
...
class CommandLibrary():
    ...
    def compile_active_xtsm(self, params):
        ...
        if parent_dc == '':
            ...
            parserOutput=dc.get('_active_xtsm_obj').parse(sn)
            params['request']['protocol'].transport.write(str(bytearray(parserOutput.package_timingstrings())))
            params['request']['protocol'].transport.loseConnection()
            dc.update({'_shotnumber':(sn+1)})
