...
help_fields.available_fields.push(	'Scale');
help_fields.quick_descript.push(	'The overall scale on this channel in the units that should appear in the control array - e.g. an analog output card with +/- 10V output would be 20.');
help_fields.links.push(				'https://amo.phys.psu.edu/GemelkeLabWiki/index.php/Scale_(Timing_Element)');
...
help_fields.quick_descript.push(	'The value to output - will be parsed by IDL and subject to modification by channel definition.');
...
help_fields.quick_descript.push(	"The time at which the serial data transfer is signaled complete on the update strobe channel.");
